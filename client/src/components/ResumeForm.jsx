      ...
      <div className="animate-slide bg-gray-700 rounded-md w-3/2 p-4">
        <form action="" onSubmit={handleBuildData}>
            ...
            >
              ...
              {i === data.positions.length - 1 && (
                <button
                  ...
                  className="relative inline-flex items-center justify-start px-6 py-2 overflow-hidden font-medium transition-all bg-cyan-600 rounded hover:bg-cyan-800 group"
                >
          ...
          <div className="w-full  flex justify-end">
            ...
            <button
              type="submit"
              className="relative mt-6 hover:translate-y-[2px] transition-all inline-flex items-center  justify-center p-4 px-8 w-3/2 py-3 overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group"
            >
              <span className="absolute top-0 left-0 w-40 h-40 -mt-10 -ml-3 transition-all duration-700 bg-teal-600 rounded-full blur-md ease"></span>
              <span className="absolute inset-0 w-full bg-teal-500 h-full transition duration-700  ease">
                <span className="absolute transition-all duration-700  ease group-hover:left-[13rem] bottom-0 left-0 w-[12rem] h-24 -ml-10 bg-[#5227C7] rounded-full blur-md"></span>
                <span className="absolute transition-all duration-700  ease group-hover:left-0 bottom-0 right-0 w-[12rem] h-24 -mr-10 bg-teal-400 rounded-full blur-md"></span>
              </span>
